  ...
  return (
    <div className='flex flex-col items-center w-full'>
      ...
      <form action={action} className='flex flex-col justify-center gap-5 w-4/6'>
        <FormInput errors={state?.fieldErrors?.email} iconComponent={<SvgIcon iconType={IconTypes.email}/>} name='email' placeholder='Email' />
        <FormInput errors={state?.fieldErrors?.username} iconComponent={<SvgIcon iconType={IconTypes.user}/>} name='username' placeholder='Username' />
        <FormInput errors={state?.fieldErrors?.password} iconComponent={<SvgIcon iconType={IconTypes.password}/>} type='password' name='password' placeholder='Password'/>
        <FormButton/>
        {state === true &&
